...
@Component({
  selector: 'app-booking-charts-sells-home',
  templateUrl: './booking-charts-sells-home.component.html',
  styleUrls: ['./booking-charts-sells-home.component.css']
})
export class BookingChartsSellsHomeComponent implements OnInit {
